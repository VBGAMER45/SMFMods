				...
				<table width="95%" cellspacing="0" align="center" cellpadding="4" class="tborder">
					...
					foreach ($context['feeds'] as $key => $feed)
					{
						echo '<tr class="' . $styleClass . '">
								...
								<td><a href="', $scripturl, '?action=admin;area=feedsadmin;sa=editfeed&id=', $feed['ID_FEED'], '">', $feed['title'], '</a></td> 
								...
								<td><a href="', $scripturl, '?action=admin;area=feedsadmin;sa=editfeed&id=', $feed['ID_FEED'], '">', $txt['feedposter_editfeed'], '</a></td> 
							</tr>
						';
