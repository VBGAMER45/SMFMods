...
function template_mainview()
{
	...
	if (empty($cat))
	{
		...
		<tr class="catbg">
				...
				if ($m_cats)
					echo '<th scope="col" class="smalltext last_th">' . $txt['smflinks_options'] .'</th>';
		echo '
			</tr>
			</thead>';
...
';
		...
		<tr class="catbg">
						...
						{
							echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=links;cat=' . $cat .  ';start=' . $context['start'] . ';sort=hits;sorto=' . $newsorto . '">' . $txt['smflinks_chits'] . '</a></th>';
							$numofspans++;
						}

						if (!empty($modSettings['smflinks_disp_rating']))
						{
							echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=links;cat=' . $cat .  ';start=' . $context['start'] . ';sort=rating;sorto=' . $newsorto . '">' . $txt['smflinks_crating'] . '</a></th>';
							$numofspans++;
						}
						if (!empty($modSettings['smflinks_disp_membername']))
						{
							echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=links;cat=' . $cat .  ';start=' . $context['start'] . ';sort=username;sorto=' . $newsorto . '">' . $txt['smflinks_cusername'] . '</a></th>';
							$numofspans++;
						}
						if (!empty($modSettings['smflinks_disp_date']))
						{
							echo '<th scope="col" class="smalltext"><a href="' . $scripturl . '?action=links;cat=' . $cat .  ';start=' . $context['start'] . ';sort=date;sorto=' . $newsorto . '">' . $txt['smflinks_cdate'] . '</a></th>';
							$numofspans++;
						}
...
<table cellspacing="0" align="center" cellpadding="4" class="tborder" width="100%">
  ...
  <tr>
    <td width="28%"  class="windowbg2" align="right"><span class="gen"><b>' . $txt['smflinks_ctitle'] . '</b></span></td>
    <td width="72%"  class="windowbg2"><input type="text" name="title" size="64" maxlength="100" /></td>
  </tr>
  <tr>
    <td width="28%" class="windowbg2" align="right"><span class="gen"><b>' . $txt['smflinks_parentcategory'] .'</b>&nbsp;</span></td>
  ...
  <tr>
    <td width="28%"   valign="top" class="windowbg2" align="right"><span class="gen"><b>' . $txt['smflinks_description'] . '</b></span></td>
  ...
  <tr>
    <td width="28%"   class="windowbg2" align="right"><span class="gen"><b>' . $txt['smflinks_image'] . '</b>&nbsp;</span></td>
...
<table cellspacing="0"  align="center" cellpadding="4" class="tborder" width="100%">
  ...
  <tr>
    <td width="28%"   class="windowbg2"><span class="gen"><b>' . $txt['smflinks_ctitle'] . '</b></span></td>
    <td width="72%"   class="windowbg2"><input type="text" name="title" size="64" maxlength="100" /></td>
  </tr>
  <tr>
    <td width="28%"   class="windowbg2"><span class="gen"><b>' . $txt['smflinks_category'] . '</b></span></td>
...
echo '</select>
  ...
  <tr>
    <td width="28%"   class="windowbg2"><span class="gen"><b>' . $txt['smflinks_url'] . '</b></span></td>
    <td width="72%"   class="windowbg2"><input type="text" name="url" size="64" maxlength="250" value="http://" /></td>
  </tr>
  <tr>
    <td width="28%"   valign="top" class="windowbg2"><span class="gen"><b>' . $txt['smflinks_description'] . '</b></span></td>
...
<table cellspacing="0" align="center" cellpadding="4" class="tborder" width="100%">
  <tr>
    <td class="catbg"><b>' . $txt['smflinks_url'] . '</b></td>
    <td class="catbg"><b>' . $txt['smflinks_ctitle'] .'</b></td>
    <td class="catbg"><b>' . $txt['smflinks_description'] . '</b></td>
    <td class="catbg"><b>' .  $txt['smflinks_category'] . '</b></td>
    <td class="catbg"><b>' . $txt['smflinks_submittedby'] . '</b></td>
    <td class="catbg"><b>' . $txt['smflinks_options'] . '</b></td>
  </tr>';
		  ...
		  echo '</tr>';
 			...
 			// Show the pages
				echo '<tr class="titlebg">
						...
						$context['page_index'] = constructPageIndex($scripturl . '?action=links;sa=alist', $_REQUEST['start'], $total, 20);
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg">
			...
			' . $txt['smflinks_setlinksperpage'] . '&nbsp;<input type="text" name="smflinks_setlinksperpage" value="' .  $modSettings['smflinks_setlinksperpage'] . '" /><br />
				...
				<b>' . $txt['smflinks_linkdisplay'] . '</b><br />
...
function template_catperm()
{
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
	    ...
	    <tr class="windowbg2">
			  	<td align="right"><b>' . $txt['smflinks_groupname'] . '</b>&nbsp;</td>
