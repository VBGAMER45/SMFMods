...
<table cellspacing="0" align="center" cellpadding="4" class="tborder" width="100%">
  ...
  <tr>
    ...
    <input type="submit" value="' . $txt['smflinks_addcat'] . '" name="submit" class="button_submit" /></td>
...
<table cellspacing="0" align="center" cellpadding="4" class="tborder"  width="100%">
 ...
 <tr>
  ...
  <tr>
    ...
    <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
    <input type="submit" value="' . $txt['smflinks_editcat'] . '" name="submit" class="button_submit" /></td>
...
<table border="1" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
    <input type="submit" value="' . $txt['smflinks_deltcat'] . '" name="submit" class="button_submit" /></td>
  </tr>
</table>
</form>';
...
echo '</select>
  ...
  <tr>
    <td width="28%" colspan="2" align="center" class="windowbg2">
    <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
    <input type="submit" value="' . $txt['smflinks_addlink'] .'" name="submit" class="button_submit" /></td>
  </tr>
</table>
</form>';
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
    <input type="submit" value="' . $txt['smflinks_dellink'] . '" name="submit" class="button_submit" /></td>
  </tr>
</table>
</form>';
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg">
			...
			' . $txt['smflinks_setlinksperpage'] . '&nbsp;<input type="text" name="smflinks_setlinksperpage" value="' .  $modSettings['smflinks_setlinksperpage'] . '" /><br />
				...
				<br />
                <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
				<input type="submit" name="savesettings" value="' . $txt['smflinks_settings_save'] .'" class="button_submit" />
			</form>
			</td>
		</tr>
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
	    ...
	    <tr class="windowbg2">
			  ...
			  <tr class="windowbg2">
                ...
                <input type="hidden" name="', $context['session_var'], '" value="', $context['session_id'], '" />
			  	<input type="submit" value="' . $txt['smflinks_text_addperm'] . '" class="button_submit" /></td>
