...
function view()
{
	...
	if (isset($_REQUEST['cat']))
	{
		...
		// Set the page title
		$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $row['title'];
	...
	{
		$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'];
		$dbresult = $smcFunc['db_query']('', '
...
function GetParentLink($ID_CAT)
{
	...
	if ($smcFunc['db_num_rows']($dbresult1) == 0)
		fatal_error($txt['smflinks_nocatselected'], false);
	else
...
function AddCat()
{
	...
	// Set the page title
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_addcat'];
...
function AddCat2()
{
	...
	// Can we be here? And a session check.
	isAllowedTo('links_manage_cat');
    checkSession('post');
...
function EditCat()
{
	...
	// Set the page title
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_editcat'];
...
function EditCat2()
{
	...
	// Can we be here? Check session, too.
	isAllowedTo('links_manage_cat');
    checkSession('post');
...
function DeleteCat()
{
	...
	// Set the page title
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_deltcat'];
}
...
function AddLink()
{
	...
	// Set the page title
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_addlink'];
...
function EditLink()
{
	global $context, $txt, $smcFunc, $modSettings, $sourcedir, $user_info;
	...
	//Set the page title
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_editlink'];
...
function ApproveList()
{
	...
	// Set the page title
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] .' - ' . $txt['smflinks_approvelinks'] ;
...
function RateLink()
{
	...
	// Pull the result associated with the id.
 	$dbresult = $smcFunc['db_query']('', '
		SELECT ID_LINK
		FROM {db_prefix}links
		WHERE ID_LINK = {int:this_id}
...
function LinksAdmin()
{
	global $context, $txt;
	isAllowedTo('links_manage_cat');
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_settings'];
	DoLinksAdminTabs();
...
function LinksAdminCats()
{
	global $context, $txt, $smcFunc;
	isAllowedTo('links_manage_cat');
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_managecats'];
	DoLinksAdminTabs();
...
function LinksAdminPerm()
{
	...
	isAllowedTo('links_manage_cat');
	DoLinksAdminTabs();
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_catpermlist'];
...
function CatPerm()
{
	...
	// Set the page title
	$context['page_title'] = $context['forum_name'] . $txt['smflinks_title'] . ' - ' . $txt['smflinks_text_catperm'] . ' - ' . $context['links_cat_name'];
