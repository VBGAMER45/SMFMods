...
function template_whoquoted_settings()
{
 ...
 <div class="cat_bar">
	...
	<form method="post" name="frmsettings" id="frmsettings" action="', $scripturl, '?action=whoquoted;sa=settings2" accept-charset="', $context['character_set'], '">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	    ...
	    <tr>
	    	<td class="windowbg2" colspan="2" align="center"><strong><a href="', $scripturl, '?action=whoquoted;sa=rebuild">' .  $txt['who_quoted_click_redbuild'] .'</a></strong><br /><br /></td>
	    </tr>     	    
	  <tr>
...
function template_rebuild_quotelog()
{
	...
	echo '<form action="' . $scripturl . '?action=whoquoted;sa=rebuild;' , $context['continue_get_data'], '" method="post" accept-charset="', $context['character_set'], '" style="margin: 0;" name="autoSubmit" id="autoSubmit">
...
function template_whoquoted_display()
{
 ...
 <div class="cat_bar">
	...
	foreach($context['who_quoted_msgs'] as $row)
	{
		...
		echo '<td><a href="' . $scripturl . '?action=profile&u=' . $row['id_member_from'] . '">' . $row['realName'] . '</td>';
