...
echo '</select>
  ...
  <tr>
    ...
    <input type="submit" class="button_submit"  value="', $txt['downloads_text_addcategory'], '" name="submit" /></td>
...
echo '
  ...
  <tr>
    ...
    <input type="submit" class="button_submit"  value="' . $txt['downloads_text_editcategory'] . '" name="submit" /></td>
...
echo '
  <tr class="windowbg2">
    ...
    <input type="submit" class="button_submit"  value="', $txt['downloads_form_adddownload'], '" name="submit" /><br />';
...
echo '
  <tr class="windowbg2">
    ...
    <input type="submit" class="button_submit"  value="' . $txt['downloads_form_editdownload'] . '" name="submit" /><br />';
	...
	echo '<br /><table cellspacing="0" cellpadding="10" border="0" align="center" width="90%" class="tborder">';
		...
		if ($modSettings['down_set_file_prevnext'])
			...
			if ($modSettings['down_set_file_showrating'])
				...
				if ($g_manage || $g_delete_own || $g_edit_own || $g_report)
					echo '<br />';
...
echo '
	...
	if ($context['show_spellchecking'])
		echo '
				...
				echo '
				    <input type="submit" class="button_submit"  value="', $txt['downloads_text_addcomment'], '" name="submit" />';
...
<a href="' . $scripturl . '?action=downloads;sa=view;down=' . $context['downloads_file']['ID_FILE'] . '" target="blank">',$context['downloads_file']['title'],'</a><br />
	...
	<input type="hidden" name="id" value="' . $context['downloads_file']['ID_FILE'] . '" />
    <input type="submit" class="button_submit"  value="' . $txt['downloads_form_deldownload'] . '" name="submit" /><br />
    </td>
  </tr>
</table>
...
echo '
    <input type="submit" class="button_submit"  value="', $txt['downloads_text_addcomment'], '" name="submit" /></td>
...
And more!<br />
<a href="https://www.smfhacks.com/download-system-pro.php">https://www.smfhacks.com/download-system-pro.php</a>
<br />
...
echo '
    <input type="submit" class="button_submit"  value="' . $txt['downloads_text_editcomment'] . '" name="submit" /></td>
