	...
	if ($context['downloads_file']['allowcomments'])
	{
		...
		foreach ($context['downloads_comments'] as $i => $comment)
		{
            ...
            if ($comment['real_name'])
            {
				...
				Downloads_21_ShowUserBox($memCommID);
	...
	if ($context['show_spellchecking'])
		echo '
            ...
            <div class="roundframe centertext">';
				...
				echo '
				<a href="' . $scripturl . '?action=downloads;cat=' . $context['downloads_file']['ID_CAT'] . '">' . $txt['downloads_text_returndownload'] . '</a>
            </div>
        </div>';
...
function template_view_rating()
{
	...
	echo '
            ...
            <div class="roundframe centertext">';
				...
				echo '
				<a href="' . $scripturl . '?action=downloads;sa=view;down=' . $context['downloads_id'] . '">' . $txt['downloads_text_returnfile'] . '</a>
            </div>
        </div>';
