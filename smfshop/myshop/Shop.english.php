...
* =============================================================================== *
* Software Version:           SMFShop 3.1 (Build 12)                              *
...
global $modSettings;
$txt['shop_guest_message'] = 'Sorry, guests can\'t access the shop!<br />Please register to view this forum\'s shop<br /><br />Powered by SMFShop <br />&copy; 2013 <a href="http://www.smfhacks.com">SMFHacks</a> &copy; 2005, 2006, 2007 <a href="http://www.dansoftaustralia.net/">DanSoft Australia</a><br /><br />';
...
$txt['shop_wanna_trade'] = 'Want to trade your items? Just click on "Your Inventory" on the left-hand side of the screen, and the click on the "Trade Item" link next to the item name. The item will appear here, and users will be able to buy the item off you. You will receive a notification via IM once someone buys your item.';
