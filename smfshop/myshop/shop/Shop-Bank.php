...
* $Date:: 2007-01-18 20:19:14 +1100 (Thu, 18 Jan 2007)                          $ *
* $Id:: Shop-Bank.php 83 2007-01-18 09:19:14Z daniel15                          $ *
...
elseif($_GET['do'] == 'bank2')
{
	...
	elseif ($_POST['type'] == 'withdraw')
	{
		...
		else
		{
			...
			db_query("
				UPDATE {$db_prefix}members
				SET moneyBank = moneyBank - ({$_POST['amount']} + {$modSettings['shopFeeWithdraw']}), 
