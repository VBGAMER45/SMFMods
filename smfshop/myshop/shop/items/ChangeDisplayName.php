...
* $Id:: ChangeDisplayName.php 127 2007-11-25 04:43:36Z daniel15                 $ *
...
class item_ChangeDisplayName extends itemTemplate
{
	...
	function onUse()
	{
		global $db_prefix, $context, $item_info, $func;
		...
		$_POST['newDisplayName'] = $func['htmlspecialchars']($_POST['newDisplayName'], ENT_QUOTES);

		updateMemberData($context['user']['id'], array('realName' => '"' . $_POST['newDisplayName'] . '"'));
