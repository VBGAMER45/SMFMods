...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
	<title>SMFSIMPLE Bookmarks Database Installer</title>
...
$pvm_settings = array(
	...
	'pvm_show_avatar' => 1,
	'pvm_show_visits' => 1,
	'pvm_show_latest_visits' => 1,	
);
updateSettings($pvm_settings);

$tables = array(
  'log_profile_views' => array(
				'name' => 'log_profile_views',
				//Columns
				'columns' => array(
				array(
					'name' => 'id',
				...
				array(
					'name' => 'id_member_profile',
					'type' => 'mediumint',
					'size' => '8',
					'default' => 0,
				),
				array(
					'name' => 'id_member_visit',
					'type' => 'mediumint',
					'size' => '8',
					'default' => 0,
				),
