...
$txt['ultport_read_more'] = 'Leer Más';

//Titles Modules
$txt['up_module_title'] = 'Modulo';
$txt['up_module_ipage_title'] = 'Páginas Internas';
$txt['up_ipage_add_html'] = 'Agregar Página en HTML';
$txt['up_ipage_add_bbc'] = 'Agregar Página en BBC';
$txt['up_ipage_date_created'] = 'Fecha de Creación:';
$txt['up_ipage_member'] = 'Agregado por:';
$txt['up_ipage_date_updated'] = 'Fecha de Actualización:';
...
$txt['ipage_column_left'] = '<strong>Activar columna Izquierda para esta Página Interna?</strong>
						<br/>De esta forma, la columna Izquierda podra ser visualizada cuando se este dentro de esta Página Interna';
$txt['ipage_column_right'] = '<strong>Activar columna Derecha para esta Página Interna?</strong>
						<br/>De esta forma, la columna Derecha podra ser visualizada cuando se este dentro de esta Página Interna';
$txt['up_ipage_content'] = 'Contenido';						
$txt['up_ipage_perms'] = 'Quienes pueden ver esta Página Interna?';						
...
$txt['ultport_error_no_action'] = 'Error, acció no permitida.';
