...
$txt['down_module_last_files_title'] = '&Uacute;ltimos Archivos';
$txt['down_module_stats_title'] = 'Estad&iacute;sticas del Modulo Descargas';
$txt['down_module_unapproved_title'] = 'Archivos no Aprobados';


//New Form
$txt['down_module_warning'] = '<strong>Nota:</strong> Tu envio no aparecer&aacute; instantaneamente - debes esperar a que el Administrador apruebe tu archivo antes de que aparezca en el Modulo Descargas.';
$txt['down_module_file_name'] = 'Nombre del Archivo';
$txt['down_module_file_description'] = 'Descripci&oacute;n';
$txt['down_module_image_description'] = 'Capturas';
$txt['down_module_file_small_description'] = 'Breve Descripci&oacute;n
								<br />Se usar&aacute; en la pagina de resultados de busqueda. 
								<br />100 caracteres como m&aacute;ximo. 
								<br />HTML y BBC no permitidos';
$txt['down_module_file_section'] = 'Secci&oacute;n a la que Pertenece';								
...
$txt['down_module_file_upload_max_size'] = 'Tama&ntilde;o M&aacute;ximo de Archivos permitido [SIZE] KB
...
$txt['down_date_updated'] = 'Ultima Actualizaci&oacute;n';
$txt['down_total_downloads'] = 'Total de Descargas';

//Specific File 
$txt['down_file_title_downloads'] = 'Descargas';
$txt['down_file_title_section'] = 'Secci&oacute;n';
...
$txt['down_file_warning_no_approved'] = 'Atenci&oacute;n: Este Archivo no ha sido aprobado.';
...
$txt['down_error_no_description'] = 'Error, no ha establecido la Descripci&oacute;n.';
$txt['down_error_no_small_description'] = 'Error, no ha establecido la breve Descripci&oacute;n.';
...
$txt['down_error_no_found'] = 'Error, petici&oacute;n no encontrada.';
$txt['down_error_max_size'] = 'Tu archivo es demasiado grande. El tama&ntilde;o m&aacute;ximo permitido para archivos adjuntos es %d KB.';
$txt['down_error_canot_upload_file'] = 'No puede ser subido. Las Extensiones permitidas son: ';
$txt['down_error_no_files_section'] = 'No hay archivos en esta Secci&oacute;n';
