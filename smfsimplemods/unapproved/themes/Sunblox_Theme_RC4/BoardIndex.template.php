...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
		<table class="table_list sunblox125">
			<tbody class="header">
				<tr>
					<td colspan="5">';
		  ...
		  <tr class="sunblox324">
		   ...
		   <td class="lastpost_sub">',$txt['last_post'],'</td>
			...
			foreach ($category['boards'] as $board)
			{
				echo '
				<tr class="windowbg2">
					<td style="border-left:1px solid #D8D8D8;border:1px solid #D8D8D8;" class="icon windowbg"', !empty($board['children']) ? ' rowspan="2"' : '', '>
				...
				echo '
					...
					<td class="info" style="border:1px solid #D8D8D8;border-left:1px solid #D8D8D8;">
				...
				// Show some basic information about the number of posts, etc.
					...
					echo '					
					<td class="stats windowbg" style="border:1px solid #D8D8D8;border-left:1px solid #D8D8D8;width:8%;">
						', $board['topics'], '
					</td>
					<td class="stats windowbg" style="border:1px solid #D8D8D8;border-left:1px solid #D8D8D8;width:8%;">
						', $board['posts'], '
					...
					echo '
					<td class="windowbg" align="center" colspan="2" width="14%" style="border:1px solid #D8D8D8;border-left:1px solid #D8D8D8;">', $board['posts'], ' ', $txt['redirects'], '</td>';
					
					echo '
					<td class="lastpost" style="border:1px solid #D8D8D8;border-left:1px solid #D8D8D8;">';
				...
				if (!empty($board['children']))
				{
					...
					echo '
					<tr>
						<td colspan="4" class="children windowbg" style="border:1px solid #D8D8D8;">
	...
	if (@$settings['show_stats_center'])
     echo template_info_center();
  else echo'';
echo'<span class="clear upperframe"><!-- The elegant By smfsimple --></span>';
}
