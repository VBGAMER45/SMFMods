...
function template_main()
{
		...
		<div class="table_frame">
			<table class="table_list">
				<tbody id="board_', $context['current_board'], '_children" class="content">
				 <tr class="sunblox324">
		   <td colspan="2" class="first">', $txt['parent_boards'], '</td>
		   <td class="stats_sub" width="15%">', $txt['topics'],' / ', $txt['posts'],'</td>
		...
		foreach ($context['boards'] as $board)
		{
			echo '
				...
				<tr id="board_', $board['id'], '" class="windowbg2">
					<td style="border:1px solid #D8D8D8;" class="icon windowbg"', !empty($board['children']) ? ' rowspan="2"' : '', '>
			...
			echo '
					...
					<td style="border:1px solid #D8D8D8;" class="info">
			...
			echo '
					...
					<td style="border:1px solid #D8D8D8;" class="stats windowbg">
						<p>', comma_format($board['posts']), ' ', $board['is_redirect'] ? $txt['redirects'] : $txt['posts'], ' <br />
						', $board['is_redirect'] ? '' : comma_format($board['topics']) . ' ' . $txt['board_topics'], '
						</p>
					</td>
					<td style="border:1px solid #D8D8D8;" class="lastpost">';
	...
	<div class="tborder topic_table" id="messageindex">
		...
		{
			echo '
				<tr class="sunblox324 whos_viewing">
		...
		if (!empty($context['topics']))
		{
			echo '
		            ...
		            <td class="stats_sub"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=subject', $context['sort_by'] == 'subject' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['subject'], $context['sort_by'] == 'subject' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> / <a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=starter', $context['sort_by'] == 'starter' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['started_by'], $context['sort_by'] == 'starter' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></td>
		            <td class="stats_sub" width="14%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=replies', $context['sort_by'] == 'replies' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['replies'], $context['sort_by'] == 'replies' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> / <a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=views', $context['sort_by'] == 'views' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['views'], $context['sort_by'] == 'views' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></td>';
		   // Show a "select all" box for quick moderation?
			if (empty($context['can_quick_mod']))
				echo '
					<td scope="col" class="lefttext last_th" width="22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></td>';
			else
				echo '
					<td scope="col" class="lefttext" width="22%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['last_post'], $context['sort_by'] == 'last_post' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></td>';

			// Show a "select all" box for quick moderation?
			if (!empty($context['can_quick_mod']) && $options['display_quick_mod'] == 1)
				echo '
					<td scope="col" class="last_th" width="24"><input type="checkbox" onclick="invertAll(this, this.form, \'topics[]\');" class="input_check" /></td>';

			// If it's on in "image" mode, don't show anything but the column.
			elseif (!empty($context['can_quick_mod']))
				echo '
					<td class="last_th" width="4%">&nbsp;</td>';
		}
		// No topics.... just say, "sorry bub".
		else
			echo '
					<td scope="col" class="first_th" width="8%">&nbsp;</td>
					<td colspan="3"><strong>', $txt['msg_alert_none'], '</strong></td>
					<td scope="col" class="last_th" width="8%">&nbsp;</td>';
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
				<tr>
					<td style="border:1px solid #D8D8D8;" class="icon1 ', $color_class, '">
						<img src="', $settings['images_url'], '/topic/', $topic['class'], '.gif" alt="" />
					</td>
					<td style="border:1px solid #D8D8D8;" class="icon2 ', $color_class, '">
						<img src="', $topic['first_post']['icon_url'], '" alt="" />
					</td>
					<td style="border:1px solid #D8D8D8;" class="subject ', $alternate_class, '">
			...
			echo '
					...
					<td style="border:1px solid #D8D8D8;" class="stats ', $color_class, '">
						', $topic['replies'], ' ', $txt['replies'], '
						<br />
						', $topic['views'], ' ', $txt['views'], '
					</td>
					<td style="border:1px solid #D8D8D8;" class="windowbg2 ', $alternate_class, '">
	...
	echo'<div class="lentre1">';theme_linktree();echo'</div>';
