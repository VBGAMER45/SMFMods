...
function template_main()
{
	...
	if ($context['is_poll'])
	{
		echo '
			<div id="poll">
				...
				<div class="windowbg">
					<span class="topslice"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span>
		...
		echo '
					...
					<span class="botslice"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span>
				</div>
			</div>
	...
	echo '<span class="clear upperframe"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span><div class="roundframe" style="text-align:center;">
	             <h1>', $txt['topic'], ': &nbsp;&nbsp;<span style="font-size:16px;color:#830202;">', $context['subject'], '</span> &nbsp;&nbsp;(', $txt['read'], ' ', $context['num_views'], ' ', $txt['times'], ')</h1>
				 <hr />
				 <span id="whoisviewing" class="smalltext">';
		...
		echo $txt['who_and'], @$context['view_num_guests'], ' ', @$context['view_num_guests'] == 1 ? $txt['guest'] : $txt['guests'], $txt['who_viewing_topic'], '
				</span></div><span class="clear lowerframe"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span>
			<div id="forumposts">
				<div class="cat_bar">
				</div>';
	...
	while ($message = $context['get_message']())
	{
		...
		echo ' <div class="information ', $message['approved'] ? ($message['alternate'] == 0 ? 'windowbg' : 'windowbg2') : 'approvebg', '">
					<div class="post_wrapper">';
        // Show information about the poster of this message.
		echo '
						<div class="poster"><span class="clear upperframe"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span>
						<div class="sunbloxposter">
							<h4>';
		...
		if (!empty($message['member']['title']))
			echo '
								<li class="title"><hr />', $message['member']['title'], '</li>';
         // Show the member's primary group (like 'Administrator') if they have one.
		if (!empty($message['member']['group']))
			echo '
								<li class="membergroup"><hr />', $message['member']['group'], '</li>';
		...
		if (!$message['member']['is_guest'])
		{
			...
			if ((empty($settings['hide_post_group']) || $message['member']['group'] == '') && $message['member']['post_group'] != '')
				echo '
								<li class="postgroup"><hr />', $message['member']['post_group'], '</li>';
			echo '
								<li class="stars"><hr />', $message['member']['group_stars'], '</li>';
			...
			else echo'<li class="avatar"><hr />
									<img src="'. $settings['images_url']. '/icons/no_avatar.jpg" alt="no avatar" />
								</li>';					
            // Show how many posts they have made.
			if (!isset($context['disabled_fields']['posts']))
				echo '
								<li class="postcount"><hr />', $txt['member_postcount'], ': ', $message['member']['posts'], '</li>';
            // Is karma display enabled?  Total or +/-?
			if ($modSettings['karmaMode'] == '1')
				echo '
								<li class="karma"><hr />', $modSettings['karmaLabel'], ' ', $message['member']['karma']['good'] - $message['member']['karma']['bad'], '</li>';
			...
			if (!empty($settings['show_gender']) && $message['member']['gender']['image'] != '' && !isset($context['disabled_fields']['gender']))
				echo '
								<li class="gender"><hr />', $txt['gender'], ': ', $message['member']['gender']['image'], '</li>';
             // Show their personal text?
			if (!empty($settings['show_blurb']) && $message['member']['blurb'] != '')
				echo '
								<li class="blurb"><hr />', $message['member']['blurb'], '</li>';
		...
		echo '
						...
						<span class="lowerframe"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span></div>
						<div class="postarea">
		...
		echo '
						...
						<span class="clear upperframe"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span>
						<div class="roundframe" id="msg_', $message['id'], '_signature">', $message['member']['signature'], '</div>
						<span class="lowerframe"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span>';
		
		echo'</div></div>
				<span class="botslice"><!-- Sunblox Theme By Smfsimple.com --></span>
				</div>
		...
		echo '
			...
			<div class="tborder" id="quickreplybox">
				...
				<div id="quickReplyOptions"', $options['display_quick_reply'] == 2 ? '' : ' style="display: none"', '>
					<span class="upperframe"><!-- Sunblox Theme By Smfsimple.com --><span><!-- Sunblox Theme By Smfsimple.com --></span></span>
