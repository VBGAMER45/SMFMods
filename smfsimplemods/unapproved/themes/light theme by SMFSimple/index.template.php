...
<head>';
	...
	if (!empty($settings['newstats_enable']))
	{
	echo'
		<script type="text/javascript" src="', $settings['theme_url'], '/scripts/statistics.js"></script>';
	}
	echo '
			</head>
<body>';
...
function template_body_below()
{
	...
	<div id="footer_body">
		<ul class="reset">
			...
			<li class="copyright">Light Theme by <a href="https://www.smfsimple.com">SMFSimple</a></li>
		</ul>';
