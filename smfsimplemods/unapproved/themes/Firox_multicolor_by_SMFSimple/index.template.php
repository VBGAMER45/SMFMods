...
<div id="full_header" style="width: ' . $settings['forum_width'] . '">' : '', '';
...
// Begin SMFSimple.com Menu And Search
	...
	echo !empty($settings['forum_width']) ? '
<div id="full_menu" style="width: ' . $settings['forum_width'] . '">' : '', '';
	...
	echo !empty($settings['forum_width']) ? '
<div id="ss_variant_pos" style="width: ' . $settings['forum_width'] . '">' : '', '';
...
function template_body_below()
{
	...
	<div id="footer_section">
		...
		<a href="https://www.smfsimple.com" title="SMFSimple.com Themes and Mods">Firox Multicolor by SMFSimple.com</a>
		</td></tr></table>
	...
	if ($context['show_load_time'])
		echo '
		<p align="center">', $txt['page_created'], $context['load_time'], $txt['seconds_with'], $context['load_queries'], $txt['queries'], '</p>';
}
	...
	<div class="navigate_section">
		<ul>
			<li class="linktree_ss">
				<a href="'.$scripturl.'" title="home">
					<img class="linktree_ss" src="'.$settings['images_url'].'/theme/home.png" alt="home" />
				</a>
			</li>';
