...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo '
			<tbody class="header"  id="category_', $category['id'], '">
				<tr>
					<td colspan="4">
						<div class="cat_bar" style="margin-bottom: 8px;margin-top: 10px;">
							<h3 class="catbg">';
		...
		echo '
			<tbody class="content cat_theme" id="category_', $category['id'], '_boards">';
			...
			{
				echo '
				<tr id="board_', $board['id'], '" class="bordertable">
	...
	<div id="posting_icons" class="floatleft">';
		...
		echo '
		<ul class="reset">
			<li class="floatleft"><img style="width:12px;" src="', $settings['images_url'], '/new_some.png" alt="" /> ', $txt['new_posts'], '</li>
			<li class="floatleft"><img style="width:12px;" src="', $settings['images_url'], '/new_none.png" alt="" /> ', $txt['old_posts'], '</li>
			<li class="floatleft"><img style="width:12px;" src="', $settings['images_url'], '/new_redirect.png" alt="" /> ', $txt['redirect_board'], '</li>
		</ul>
	</div>';
...
function template_info_center()
{
	...
	echo '<br /><br /><br />
	<div class="cat_infocenter"><div class="innerframe">
		<div class="cat_bar" style="border-radius: 3px 3px 0px 0px;">
			<h3 class="catbg" style="color: #f5f5f5;">
	...
	if (!empty($settings['number_recent_posts']) && (!empty($context['latest_posts']) || !empty($context['latest_post'])))
	{
		echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft" style="color: #888;">
