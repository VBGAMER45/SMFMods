	...
	<tr>
		<td class="windowbg">
			<table border="0" cellspacing="0" cellpadding="2" width="100%">
				...
				<tr><td>' . $txt['smftrader_positivefeedback']  . $pcount . '&nbsp;<img src="' . $modSettings['smileys_url'], '/', $context['user']['smiley_set'], '/smiley.png" alt="positive" /></td></tr>
				<tr><td>' . $txt['smftrader_neutralfeedback']   .  $neturalcount . '&nbsp;<img src="' . $modSettings['smileys_url'], '/', $context['user']['smiley_set'], '/undecided.png" alt="netural" /></td></tr>
				<tr><td>' . $txt['smftrader_negativefeedback']   .  $ncount . '&nbsp;<img src="' . $modSettings['smileys_url'], '/', $context['user']['smiley_set'], '/angry.png" alt="negative" /></td></tr>
				<tr><td>' . $txt['smftrader_totalfeedback']   .  ($pcount - $ncount) . '</td></tr>';

				
				if ($user_info['id'] != $context['traderid'])
				echo '
			...
			foreach ($context['trader_feedback'] as $row)
			{
				...
				switch($row['salevalue'])
				{
					...
					case 0:
					echo '<td align="center"><img src="', $modSettings['smileys_url'], '/', $context['user']['smiley_set'], '/smiley.png" alt="positive" /></td>';

					break;
					case 1:
					echo '<td align="center"><img src="', $modSettings['smileys_url'], '/', $context['user']['smiley_set'], '/undecided.png" alt="netural" /></td>';
					break;
					case 2:
					echo '<td align="center"><img src="', $modSettings['smileys_url'], '/', $context['user']['smiley_set'], '/angry.png" alt="negative" /></td>';
					break;
					default:
	...
	<tr>
		<td class="windowbg">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
					<td width="25%" valign="top">',$txt['smftrader_detailedcomment'],'</td>
					<td align="left">' . parse_bbc($context['trader_feedback']['comment_long']) . '<br />',$txt['smftrader_commentby'],'<a href="' . $scripturl . '?action=profile;u=' . $context['trader_feedback']['FeedBackMEMBER_ID'] . '">' . $context['trader_feedback']['real_name'] .  '</a><br /></td>
...
<div class="tborder">
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg2">
			...
			<input type="checkbox" name="trader_approval" ' . ($modSettings['trader_approval'] ? ' checked="checked" ' : '') . ' />' . $txt['smftrader_trader_approval'] . ' <a href="', $scripturl, '?action=helpadmin;help=trader_approval" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.png" alt="', $txt['help'], '" align="top" /></a><br />
			<input type="checkbox" name="trader_use_pos_neg" ' . ($modSettings['trader_use_pos_neg'] ? ' checked="checked" ' : '') . ' />' . $txt['trader_use_pos_neg'] . ' <a href="', $scripturl, '?action=helpadmin;help=trader_use_pos_neg" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.png" alt="', $txt['help'], '" align="top" /></a><br />
			...
			<br /><a href="' . $scripturl . '?action=admin;area=permissions">' . $txt['smftrader_set_editpermissions']  . '</a>
...
<tr class="windowbg2"><td><b>Has SMF Trader System helped you?</b> Then support the developers:<br />
	...
	<input type="image" src="https://www.paypal.com/en_US/i/btn/x-click-butcc-donate.png" border="0" name="submit" alt="Make payments with PayPal - it is fast, free and secure!" />
