...
require_once(str_replace('//','/',dirname(__FILE__).'/').'../SSI.php');

global $modSettings, $scripturl, $apiConfig;
...
$apiConfig = array(
    ...
    'oauth2_client_id' => $modSettings['gp_app_client_id'],
    'oauth2_client_secret' => $modSettings['gp_app_client_secret'],
    'oauth2_redirect_uri' => $scripturl.'?action=gplus',

    // The developer key, you get this at https://code.google.com/apis/console
    'developer_key' => $modSettings['gp_app_client_id'],
