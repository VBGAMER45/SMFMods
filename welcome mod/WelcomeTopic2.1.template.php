...
echo '</select><br />
			...
			<table align="center" class="table_grid" cellspacing="0" cellpadding="4">
			<tr class="title_bar">
...
echo '
	...
	echo '<div align="center"><!--Link must remain or contact me to pay to remove.--><a href="https://www.smfhacks.com" target="blank">Welcome Topic Mod</a><!--End Copyright link--></div>';
...
echo '
	...
	// Copryright link must remain. To remove you need to purchase link removal at smfhacks.com
	echo '<div align="center"><a href="https://www.smfhacks.com" target="blank">Welcome Topic Mod</a></div>';
