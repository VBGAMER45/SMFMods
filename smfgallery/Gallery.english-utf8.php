...
$txt['gallery_error_category'] = 'Category not found';

$txt['gallery_upload_max_filesize'] = 'PHP: Upload Max Filesize ';
$txt['gallery_post_max_size'] = 'PHP: Post Max Filesize ';
$txt['gallery_upload_limits_notes'] = 'The above PHP settings control how large a file will be accepted by the gallery. These are settings are controlled by the php.ini or your webhost';
...
$txt['gallery_txt_copyremovalnote'] = 'Copyright removal removes the text at the bottom of the gallery pages titled "Powered by SMF Gallery" and removes any link back to smfhacks.com';
...
$txt['gallery_txt_findotherconvetors'] = 'Here you will find any converters that we have from other software to SMF Gallery';

$txt['gallery_txt_begin_import'] = 'Begin Import';
$txt['gallery_text_import_warning'] = 'Warning! The import will erase ALL current data from SMF Gallery!';
$txt['gallery_text_aevapathnotfound'] = 'Aeva path not found! Make sure Aeva files are there and the modification is installed!';
$txt['gallery_txt_inorderimport'] = 'In order to import the gallery we need some information on your Aeva setup.';
$txt['gallery_txt_pathtoimportaeva'] = 'Path to Aeva:';


$txt['gallery_import_clearingsmfgallery'] = 'Clearing SMF Gallery Data';
$txt['gallery_import_mainpictures'] = 'Importing Main Pictures';
$txt['gallery_import_categories'] = 'Importing Categories';

$txt['gallery_import_userpictures'] = 'Importing Users Pictures';
$txt['gallery_import_ratings'] = 'Importing Ratings';
$txt['gallery_import_comments'] = 'Importing Comments';
$txt['gallery_import_unviewedlog'] = 'Importing Unviewed Log';
$txt['gallery_import_recounting'] = 'Recounting Galleries';

$txt['gallery_import_complete'] = 'Import Complete!';

$txt['gallery_avea_imported'] = 'Aeva Media information Imported!';
$txt['gallery_visit_imported_gallery'] = 'Visit imported Gallery';

$txt['gallery_visit_promo1'] = 'Special Offering for SMF Gallery Pro for Aeva Media Converts!';
$txt['gallery_visit_promo2'] = 'Visit this site for details: ';

$txt['gallery_import_welcome'] = 'Welcome to the Aeva Media Importer for SMF Gallery';


//Begin SMF Gallery Text Strings
$txt['smfgallery_title'] = 'Gallery For SMF';
$txt['smfgallery_menu'] = 'Gallery';
$txt['smfgallery_version'] = '7.0 Lite';
...
$txt['permissionhelp_smfgallery_manage'] = 'Allows the user to add/delete/edit all categories. Delete Comments, Delete Pictures, Approve Pictures';
