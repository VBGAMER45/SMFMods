...
function template_mainview()
{
	...
	ShowTopGalleryBar2($txt['gallery_text_title']);
...
<thead>
<tr class="title_bar">
				<th class="lefttext first_th" colspan="2">', $txt['gallery_text_galleryname'], '</th>
				<th class="lefttext">', $txt['gallery_text_gallerydescription'], '</th>
				<th class="centertext ' . ($g_manage ? ''  : 'last_th') . '" align="center">', $txt['gallery_text_totalimages'], '</th>
				';
		if ($g_manage)
		echo '
...
<form method="post" name="catform2" id="catform2" action="' . $scripturl . '?action=gallery&sa=addcat2" accept-charset="', $context['character_set'], '" onsubmit="submitonce(this);">

<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr class="windowbg2">
    <td width="28%"  align="right"><b>' . $txt['gallery_form_title'] .'</b>&nbsp;</td>
    <td width="72%" class=><input type="text" name="title" size="64" maxlength="100" /></td>
  </tr>
  <tr class="windowbg2">
    <td width="28%"  valign="top" align="right"><b>' . $txt['gallery_form_description'] . '</b>&nbsp;</td>
    <td width="72%">
     <table>
   ';
...
// Showing BBC?
   ...
   echo '</table>';
   	...
   	if ($context['show_spellchecking'])
   		echo '
   									<br /><input type="button" value="', $txt['spell_check'], '" onclick="spellCheck(\'catform2\', \'description\');" />';
echo '</td>
  </tr>
  <tr class="windowbg2">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr class="windowbg2">
    <td width="28%"  align="right"><b>' . $txt['gallery_form_title'] . '</b>&nbsp;</td>
    <td width="72%"><input type="text" name="title" size="64" maxlength="100" value="' . $context['gallery_cat_edit']['title'] . '" /></td>
  </tr>
  <tr class="windowbg2">
    <td width="28%"  valign="top" align="right"><b>' . $txt['gallery_form_description'] . '</b>&nbsp;</td>
    <td width="72%">
...
echo '</td>
  ...
  <tr class="windowbg2">
    <td width="28%"  align="right"><b>' . $txt['gallery_form_icon'] . '</b>&nbsp;</td>
    <td width="72%" ><input type="text" name="image" size="64" maxlength="100" value="' . $context['gallery_cat_edit']['image'] . '" /></td>
  </tr>
  <tr class="windowbg2">
    <td width="28%" colspan="2"  align="center">
...
function template_view_picture()
{
	...
	echo '<br />
			<div class="cat_bar centertext">
								<h3 class="catbg">' . $context['gallery_pic']['title'] . '</h3>
            </div>
    <table cellspacing="0" cellpadding="10" border="0" align="center" width="100%" class="tborder">
			<tr class="windowbg2">
				<td align="center"><div class="img_gallery"><img height="' . $context['gallery_pic']['height']  . '" width="' . $context['gallery_pic']['width']  . '" src="' . $modSettings['gallery_url'] . $context['gallery_pic']['filename']  . '" alt="' . $context['gallery_pic']['title']  . '" /></div></td>
			</tr>
...
echo '
			<div class="cat_bar">
								<h3 class="catbg">' . $txt['gallery_form_managecats'] . '</h3>
            </div>
...
<thead>
<tr class="title_bar">
				<th class="lefttext first_th">', $txt['gallery_text_galleryname'], '</th>
				<th class="lefttext">', $txt['gallery_text_gallerydescription'], '</th>
				<th class="centertext">', $txt['gallery_text_totalimages'], '</th>
				<th class="lefttext">', $txt['gallery_text_reorder'], '</th>
				<th class="lefttext last_th">', $txt['gallery_text_options'], '</th>
				</tr>
</thead>';
	...
	<tr class="windowbg2"><td><b>Has SMF Gallery helped you?</b> Then support the developers:<br />
...
<br />You can also upgrade to the SMF Gallery Pro edition at <a href="https://www.smfhacks.com/smf-gallery-pro.php" target="blank">https://www.smfhacks.com/smf-gallery-pro.php</a>
</td>
</tr>
</table>';
...
echo '
			<div class="cat_bar">
								<h3 class="catbg">' . $txt['gallery_text_settings'] . '</h3>
            </div>
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="windowbg2">
			<td>
			...
			<table  border="0" width="100%" cellspacing="0"  align="center" cellpadding="4">
				...
				<tr class="windowbg2"><td>' . $txt['gallery_set_url'] . '</td><td><input type="text" name="gallery_url" value="' .  $modSettings['gallery_url'] . '" size="50" /></td></tr>

				<tr class="windowbg2"><td>' . $txt['gallery_set_maxheight'] . '</td><td><input type="text" name="gallery_max_height" value="' .  $modSettings['gallery_max_height'] . '" /></td></tr>
				...
				<tr class="windowbg2"><td>' . $txt['gallery_set_thumb_height'] . '</td><td><input type="text" name="gallery_thumb_height" value="' .  $modSettings['gallery_thumb_height'] . '" /></td></tr>
				...
				<tr class="windowbg2"><td>' . $txt['gallery_set_filesize'] . '</td><td><input type="text" name="gallery_max_filesize" value="' .  $modSettings['gallery_max_filesize'] . '" /> (bytes)</td></tr>
				...
				<tr class="windowbg2"><td width="30%">' . $txt['gallery_post_max_size'] . '</td><td><a href="http://www.php.net/manual/en/ini.core.php#ini.post-max-size" target="_blank">' . @ini_get("post_max_size") . '</a></td></tr>
				<tr class="windowbg2"><td colspan="2">',$txt['gallery_upload_limits_notes'] ,'</td></tr>



				<tr class="windowbg2"><td>' . $txt['gallery_set_images_per_page'] . '</td><td><input type="text" name="gallery_set_images_per_page" value="' .  $modSettings['gallery_set_images_per_page'] . '" /></td></tr>
				...
				echo '
				<tr class="windowbg2"><td colspan="2"><input type="checkbox" name="gallery_commentchoice" ' . (!empty($modSettings['gallery_commentchoice']) ? ' checked="checked" ' : '') . ' />' . $txt['gallery_set_commentschoice'] . '</td></tr>
				<tr class="windowbg2"><td colspan="2">' . $txt['gallery_shop_settings'] . '</td></tr>
				<tr class="windowbg2"><td>' . $txt['gallery_shop_picadd'] . '</td><td><input type="text" name="gallery_shop_picadd" value="' .  $modSettings['gallery_shop_picadd'] . '" /></td></tr>
				...
				<tr class="windowbg2"><td colspan="2"><input type="checkbox" name="gallery_set_showcode_bbc_image" ' . ($modSettings['gallery_set_showcode_bbc_image'] ? ' checked="checked" ' : '') . ' />' . $txt['gallery_set_showcode_bbc_image'] . '</td></tr>
				...
				<tr class="windowbg2"><td colspan="2"><input type="checkbox" name="gallery_set_showcode_htmllink" ' . ($modSettings['gallery_set_showcode_htmllink'] ? ' checked="checked" ' : '') . ' />' . $txt['gallery_set_showcode_htmllink'] . '</td></tr>
...
<br />You can also upgrade to the SMF Gallery Pro edition at <a href="https://www.smfhacks.com/smf-gallery-pro.php" target="blank">http://www.smfhacks.com/smf-gallery-pro.php</a>
			<br />
...
echo '
			<div class="cat_bar">
								<h3 class="catbg">' .$txt['gallery_form_approveimages'] . '</h3>
            </div>
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg2">
            ...
            <thead>
				<tr class="title_bar">
				<th class="lefttext first_th">' . $txt['gallery_app_image'] . '</th>
...
<tr class="windowbg2"><td><b>Has SMF Gallery helped you?</b> <br />
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
	<input type="hidden" name="cmd" value="_xclick">
	<input type="hidden" name="business" value="sales@visualbasiczone.com">
	<input type="hidden" name="item_name" value="SMF Gallery">
...
echo '
			<div class="cat_bar">
								<h3 class="catbg">' .$txt['gallery_form_reportimages'] . '</h3>
            </div>
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="windowbg2">
			<td>
 	...
 	echo '<div class="tborder">
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		  ...
		  <tr>
            ...
            <br />
            ' .  $txt['gallery_visit_promo2']  . '<a href="https://www.smfhacks.com/promos/aevamediaconvert.php?site=' . urlencode(base64_encode($boardurl)) . '" target="_blank">http://www.smfhacks.com/promos/aevamediaconvert.php</a>
...
function template_convertgallery()
{
    ...
    echo '
			<div class="cat_bar">
								<h3 class="catbg">' .$txt['gallery_txt_convertors'] . '</h3>
            </div>
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
...
function ShowTopGalleryBar2($title = '&nbsp;')
{
	global $txt, $context;
		echo '
