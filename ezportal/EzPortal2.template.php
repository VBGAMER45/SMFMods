...
$txt['ezp_txt_checkall'],'
	  ...
	  <tr>
	    <td width="20%" class="windowbg2" align="right"><b>', $txt['ezp_txt_showinmenu'],'</b>&nbsp;</td>	 
		<td width="80%" class="windowbg2"><input type="checkbox" name="showinmenu"></td>
	  </tr>
	  <tr>
	    <td width="20%" class="windowbg2" align="right"><b>', $txt['ezp_txt_menutext'],'</b>&nbsp;</td>	 
		<td width="80%" class="windowbg2"><input type="text" name="menutitle" size="30" /></td>
	  </tr>
	  <tr>
	    <td width="20%" class="windowbg2" align="right"><b>', $txt['ezp_txt_icon'],'</b>&nbsp;</td>	 
		<td width="80%" class="windowbg2"><input type="text" name="icon" size="30" value="page.png" /></td>
	  </tr>
	  <tr>
	    <td colspan="2" class="windowbg2" align="center">
	     <input type="hidden" name="sc" value="', $context['session_id'], '" />
	     <input type="hidden" name="bbc" value="',$context['ezp_page_bbc'], '">
	    <input type="submit" class="button_submit"  name="addpage" value="',$txt['ezp_addpage'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
';
	  ...
	  <tr>
	    <td width="20%" class="windowbg2" align="right"><b>', $txt['ezp_txt_metatags'],'</b>&nbsp;</td>
	    <td width="80%" class="windowbg2"><textarea name="metatags" rows="5" cols="55" class="">', $context['ezp_editpage_data']['metatags'],'</textarea><br />
	    ', $txt['ezp_txt_metatags2'],'
	    </td>
	  </tr> 
	  <tr>
...
$txt['ezp_txt_checkall'],'
	  ...
	  <tr>
	    <td width="20%" class="windowbg2" align="right"><b>', $txt['ezp_txt_showinmenu'],'</b>&nbsp;</td>	 
		<td width="80%" class="windowbg2"><input type="checkbox" name="showinmenu" ' . ($context['ezp_editpage_data']['showinmenu']  == 1 ? ' checked="checked" ' : '') . '></td>
	  </tr>
	  <tr>
	    <td width="20%" class="windowbg2" align="right"><b>', $txt['ezp_txt_menutext'],'</b>&nbsp;</td>	 
		<td width="80%" class="windowbg2"><input type="text" name="menutitle"  size="30" value="',$context['ezp_editpage_data']['menutitle'], '" /></td>
	  </tr>	  
	  <tr>
	    <td width="20%" class="windowbg2" align="right"><b>', $txt['ezp_txt_icon'],'</b>&nbsp;</td>	 
		<td width="80%" class="windowbg2"><input type="text" name="icon"  size="30" value="',$context['ezp_editpage_data']['icon'], '" /></td>
	  </tr>	   
	  <tr>
	    <td colspan="2" class="windowbg2" align="center">
	     <input type="hidden" name="sc" value="', $context['session_id'], '" />
	    <input type="hidden" name="p" value="', $context['ezp_editpage_data']['id_page'],'" />
	    <input type="submit" class="button_submit"  name="editpage" value="', $txt['ezp_editpage'], '" />
	    </td>
	  </tr>
	  </table>
  	</form>
...
function template_ezportal_deletepage()
{
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="50%" align="center">
	  ...
	  <tr>
	    ...
	    <input type="submit" class="button_submit"  name="delpage" value="', $txt['ezp_deletepage'], '" /></td>
	  </tr>
	  </table>
  	</form>
  ';
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="windowbg">
			...
			<form method="post" action="', $scripturl, '?action=ezportal;sa=settings2" accept-charset="', $context['character_set'], '">
				...
				<tr><td colspan="2"><input type="checkbox" name="ezp_responsivemode" ',($modSettings['ezp_responsivemode'] ? ' checked="checked" ' : ''), ' />', $txt['ezp_responsivemode'] . '<br />', $txt['ezp_responsivemode_desc'] . '</td></tr>
                ...
                <tr><td colspan="2"><input type="checkbox" name="ezp_disableblocksinadmin" ',($ezpSettings['ezp_disableblocksinadmin'] ? ' checked="checked" ' : ''), ' />', $txt['ezp_disableblocksinadmin'] . '</td></tr>
				...
				echo '
				<input type="hidden" name="sc" value="', $context['session_id'], '" />
				<input type="submit" class="button_submit"  name="savesettings" value="', $txt['ezp_savesettings'], '" />
			</form>
		...
		<tr>
			<td class="windowbg">
				...
				foreach($context['ezPortalAdminColumns']  as $row)
				{
					...
					<tr class="catbg">
						<td colspan="4">',$row['column_title'],' - <a href="', $scripturl, '?action=admin;area=ezpblocks;sa=editcolumn;column=',$row['id_column'],'"><img src="',$ezpSettings['ezp_url'],'icons/page_white_edit.png" alt="',$txt['ezp_edit2'], '" /> ',$txt['ezp_editcolumn'],'</a>
						'
					...
					<tr class="',$styleclass,'">
						...
						<input type="submit" class="button_submit"  value="',$txt['ezp_saveblocks'],'" />
						</td>
					</tr>
					</table>
					</form>
		...
		<tr>
			<td class="windowbg" align="left">
				<form method="post" action="', $scripturl,'?action=admin;area=ezppagemanager;sa=addpage">
					<input type="submit" class="button_submit"  name="btnsubmit" value="',$txt['ezp_addpage'],'" />
					<input type="submit" class="button_submit"  name="btnsubmit" value="', $txt['ezp_bbc_addpage'], '">
				</form>
			</td>
		</tr>
	</table>';
...
echo '
			 <tr>
	    <td width="20%"  class="windowbg2" align="right"><b>', $txt['ezp_txt_sticky'],'</b>&nbsp;</td>
		<td width="80%"  class="windowbg2">
	  ...
	  <tr>
	    ...
	    <td width="80%"  class="windowbg2"><a href="', $scripturl, '?action=admin;area=ezpblocks;sa=visiblesettings;column=',$context['ezp_column_data']['id_column'],'">',$txt['ezp_txt_update_visible_options'],'</a></td>
	  </tr>
	  <tr>
	    <td colspan="2" class="windowbg2" align="center">
	    <input type="hidden" name="sc" value="', $context['session_id'], '" />
	    <input type="hidden" name="column" value="',$context['ezp_column_data']['id_column'],'" />
	    <input type="submit" class="button_submit"  name="editcolumn" value="',$txt['ezp_editcolumn'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
echo '
	...
	echo '</select>
	  ...
	  <tr>
	    ...
	    <input type="submit" class="button_submit"  name="addblock" value="',$txt['ezp_addblock'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
$txt['ezp_txt_checkall'],'
	  ...
	  <tr>
		...
		<input type="checkbox" name="hidemobile" />',$txt['ezp_hidemobile'],'  <input type="checkbox" name="showonlymobile" />',$txt['ezp_showonlymobile'],' <br> 
...
<tr class="windowbg2">
	...
	echo '</select> <img id="iconPick" src="" alt="" />
...
$txt['ezp_txt_checkall'],'
	 ...
	 <tr>
	  ...
	  <tr>
	    <td width="20%"  class="windowbg2" align="right"><b>', $txt['ezp_txt_visible_areas'],'</b>&nbsp;</td>
	    <td width="80%"  class="windowbg2"><a href="', $scripturl, '?action=admin;area=ezpblocks;sa=visiblesettings;block=',$context['ezp_block_info']['id_layout'],'">',$txt['ezp_txt_update_visible_options'],'</a></td>
	  </tr>
	  <tr>
	    <td colspan="2" class="windowbg2" align="center">
	    <input type="hidden" name="sc" value="', $context['session_id'], '" />
	    <input type="hidden" name="block" value="',$context['ezp_block_info']['id_layout'],'" />
	    <input type="submit" class="button_submit"  name="editblock" value="',$txt['ezp_editblock'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
echo '<div class="cat_bar">
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
	  ...
	  <tr>
	    ...
	    <input type="submit" class="button_submit"  name="delblock" value="',$txt['ezp_deleteblock'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
function template_ezportal_download_block()
{
    ...
    <table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="bordercolor">
            <tr>
				<td class="windowbg2" style="padding: 8px;">
					<form action="',$scripturl,'?action=ezportal;sa=importblock" method="post" accept-charset="', $context['character_set'], '" enctype="multipart/form-data" style="margin-bottom: 0;">
						...
						<div style="margin: 1ex;" align="right"><input type="submit" class="button_submit"  value="',$txt['ezp_txt_upload_block'],'" /></div>
						<input type="hidden" name="sc" value="', $context['session_id'], '" />
					</form>
				</td>
			</tr>
...
echo '<!--start column ' . $ezColumn['column_title'] . '-->';
	...
	{
	 echo '<!-- ezheader1--><table style="margin: 0 auto;"  width="100%">
		<tr>';
	 $shownHeader = true;
	...
	if ($right == 1 || $left == 1 || $center == 1)
	{
		if ($shownHeader == false)
		{
		 echo '<!-- ezheader start --><table style="margin: 0 auto;"  width="100%">
			<tr>';
		 $shownHeader = true;
	
		}
		if ($tdopen == 0)
		echo '<!-- td open --><td valign="top">';
...
<div class="cat_bar">
	...
	echo '
	  ...
	  <tr>
	    ...
	    <input type="hidden" name="column" value="', $context['ezportal_column'], '" />
	    <input type="submit" class="button_submit"  name="addblock" value="', $txt['ezp_txt_savevisible'], '" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
<div class="cat_bar">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  ...
	  <tr>
	    <td colspan="2" class="windowbg2" align="center">
	    	<input type="hidden" name="sc" value="', $context['session_id'], '" />
		    <input type="submit" class="button_submit"  name="addaction" value="',$txt['ezp_txt_visible_add_new_action'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
<div class="cat_bar">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  ...
	  <tr>
	    <td colspan="2" class="windowbg2" align="center">
	    	<input type="hidden" name="sc" value="', $context['session_id'], '" />
		    <input type="submit" class="button_submit"  value="',$txt['ezp_txt_deleteallshoutbox'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
<div class="cat_bar">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  ...
	  <tr>
	    ...
	    <input type="hidden" name="sc" value="', $context['session_id'], '" />
	    <input type="submit" class="button_submit"  name="addblock" value="',$txt['ezp_txt_menu_add'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
echo '<div class="cat_bar">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  ...
	  <tr>
	    ...
	    <input type="hidden" name="sc" value="', $context['session_id'], '" />
	    <input type="submit" class="button_submit"  name="editmenu" value="',$txt['ezp_txt_menu_edit'],'" /></td>
	  </tr>
	  </table>
  	</form>
  ';
...
function template_ezportal_menu_delete()
{
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr>
	    ...
	    <input type="hidden" name="menuid" value="', $context['ezp_menu_row']['id_menu'], '" />
	    <input type="hidden" name="sc" value="', $context['session_id'], '" />
	    <input type="submit" class="button_submit"  name="editmenu" value="',$txt['ezp_txt_menu_delete'],'" /></td>
	  </tr>
	  </table>
  	</form>';
...
<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
	...
	<tr class="windowbg2">
		<td valign="top" colspan="2" align="center"><input type="submit" class="button_submit"  value="' . $txt['ezp_savesettings'] . '" />
		</td>
		</tr>
	</table>
	</form>
