...
function template_articlesmain()
{
	...
	ShowArticlesBar($txt['smfarticles_indextitle']);
		...
		<tr class="catbg">
				...
				<th scope="col" class="smalltext' . ($context['m_cats'] ? '' : ' last_th') . '" align="center">', $txt['smfarticles_totalarticles'], '</th>
				';
...
function template_articlelisting()
{
	...
	ShowSubCats($context['articles_cat_id'],$context['m_cats']);
		...
		<tr class="catbg">
						...
						{
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;cat=' , $context['articles_cat_id'] , ';start=' , $context['start'] , ';sort=rating;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_crating'] , '</a></th>';
							$spancount++;
						}

						if (!empty($modSettings['smfarticles_disp_totalcomment']))
						{
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;cat=' , $context['articles_cat_id'] , ';start=' , $context['start'] , ';sort=comment;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_txt_comments'] , '</a></th>';
							$spancount++;
						}

						if (!empty($modSettings['smfarticles_disp_views']))
						{
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;cat=' , $context['articles_cat_id'] , ';start=' , $context['start'] , ';sort=views;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_cviews'] , '</a></th>';
							$spancount++;
						}

						if (!empty($modSettings['smfarticles_disp_membername']))
						{
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;cat=' , $context['articles_cat_id'] , ';start=' , $context['start'] , ';sort=username;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_cusername'] , '</a></th>';
							$spancount++;
						}

						if (!empty($modSettings['smfarticles_disp_date']))
						{
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;cat=' , $context['articles_cat_id'] , ';start=' , $context['start'] , ';sort=date;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_cdate'] , '</a></th>';
							$spancount++;
						}
...
<table cellspacing="0" cellpadding="10" border="0" align="center" width="90%" class="table_grid">
		...
		<thead>
		<tr class="catbg">
    <th scope="col" class="smalltext first_th">', $txt['smfarticles_ctitle'], '</th>
    <th scope="col" class="smalltext">', $txt['smfarticles_category'], '</th>
    <th scope="col" class="smalltext">', $txt['smfarticles_submittedby'], '</th>
    <th scope="col" class="smalltext last_th">', $txt['smfarticles_options'], '</th>
  </tr>
  </thead>';
...
function template_catperm()
{
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<thead>
		<tr class="catbg">
				<th scope="col" class="smalltext first_th">' , $txt['smfarticles_groupname'] , '</th>
				<th scope="col" class="smalltext">' ,  $txt['smfarticles_perm_view']  , '</th>
				<th scope="col" class="smalltext">' ,  $txt['smfarticles_perm_add']  , '</th>
				<th scope="col" class="smalltext">' ,  $txt['smfarticles_perm_edit']  , '</th>
				<th scope="col" class="smalltext">' ,  $txt['smfarticles_perm_delete']  , '</th>
				<th scope="col" class="smalltext last_th">' ,  $txt['smfarticles_options']  , '</th>
				</tr>
				</thead>';
...
function template_myarticles()
{
	...
	ShowArticlesBar($txt['smfarticles_indextitle']);
		...
		<tr class="catbg">
						...
						if (!empty($modSettings['smfarticles_disp_rating']))
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;sa=myarticles;start=' , $context['start'] , ';sort=rating;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_crating'] , '</a></th>';

						if (!empty($modSettings['smfarticles_disp_totalcomment']))
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;sa=myarticles;start=' , $context['start'] , ';sort=comment;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_txt_comments'] , '</a></th>';

						if (!empty($modSettings['smfarticles_disp_views']))
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;sa=myarticles;start=' , $context['start'] , ';sort=views;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_cviews'] , '</a></th>';

						if (!empty($modSettings['smfarticles_disp_membername']))
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;sa=myarticles;start=' , $context['start'] , ';sort=username;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_cusername'] , '</a></th>';

						if (!empty($modSettings['smfarticles_disp_date']))
							echo '<th scope="col" class="smalltext"><a href="' , $scripturl , '?action=articles;sa=myarticles;start=' , $context['start'] , ';sort=date;sorto=' , $context['articles_newsorto'] , '">' , $txt['smfarticles_cdate'] , '</a></th>';
...
function template_search_results()
{
	...
	ShowArticlesBar($txt['smfarticles_searchresults']);
		...
		<tr class="catbg">
						...
						if (!empty($modSettings['smfarticles_disp_rating']))
						{
							echo '<th scope="col" class="smalltext">' , $txt['smfarticles_crating'] , '</th>';
							$spancount++;
						}

						if (!empty($modSettings['smfarticles_disp_totalcomment']))
						{
							echo '<th scope="col" class="smalltext">' , $txt['smfarticles_txt_comments'] , '</th>';
							$spancount++;
						}

						if (!empty($modSettings['smfarticles_disp_views']))
						{
							echo '<th scope="col" class="smalltext">' , $txt['smfarticles_cviews'] , '</th>';
							$spancount++;
						}

						if (!empty($modSettings['smfarticles_disp_membername']))
						{
							echo '<th scope="col" class="smalltext">' , $txt['smfarticles_cusername'] , '</th>';
							$spancount++;
						}

						if (!empty($modSettings['smfarticles_disp_date']))
						{
							echo '<th scope="col" class="smalltext">' , $txt['smfarticles_cdate'] , '</th>';
							$spancount++;
						}
...
echo '
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<thead>
		<tr class="catbg">
				<th scope="col" class="smalltext first_th">' , $txt['smfarticles_comment_link'] , '</th>
				<th scope="col" class="smalltext">' , $txt['smfarticles_txt_comments']  , '</th>
				<th scope="col" class="smalltext">' , $txt['smfarticles_cdate'] , '</th>
				<th scope="col" class="smalltext">' , $txt['smfarticles_cusername'] , '</th>
				<th scope="col" class="smalltext last_th">' , $txt['smfarticles_options'] , '</th>
				</tr>
				</thead>';
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg2">
			...
			<tr class="catbg">
				...
				<td>' . $txt['smfarticles_totalarticles'] . '</td>
