...
function template_main()
{
	...
	echo '
		...
		<table class="tborder" align="center"  border="0" width="80%" cellspacing="1" cellpadding="4">
			<tr class="titlebg">
				<td colspan="2">', $txt['ad_management_main'] ,'</td></tr>
			<tr class="catbg3">
				...
				for ($i=0;$i<count($adverts);$i++)
				{
					echo '
						<tr class="windowbg2">
							...
							<td class="windowbg2" align="center"><a href="' . $scripturl . '?action=admod;sa=edit;ad=' . $adverts[$i]['id'] . '">' . $txt['ad_manage_admin_modify'] . '</a></td>
						</tr>';
				}
...
<table>
	...
	<a href="https://www.revenuehits.com/lps/pubref/?ref=@RH@dK6epyQmAa_IjkEbC7aurILIRLfbhe5D" target="_blank"><img src="https://revenuehits.com/publishers/media/img/v2/125x125_v2.png" border="0"></a>
...
function template_addAds()
{
	...
	echo '
		<div class="tborder">
		<form action="', $scripturl, '?action=admod;sa=add" method="post">
		<table border="0" width="100%" cellspacing="1" cellpadding="4" class="bordercolor">
			<tr class="titlebg">
				<td colspan="2">', $txt['ad_management_add'] ,'</td>
			</tr>
			<tr class="windowbg2">
				<td width="35%" align="center"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_name" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_name'] ,'</td>
				<td width="65%"><input type="text" name="name" /></td>
			</tr>
			<tr class="windowbg2">
				<td align="center"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_content" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_content'] ,'</td>
			...
			<tr class="windowbg2">
				<td colspan="2">
					<table border="0" width="80%" cellspacing="1" cellpadding="4">
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_boards" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_boards'] ,'</td>
							<td><input type="text" name="boards" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_posts" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_posts'] ,'</td>
							<td><input type="text" name="posts" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_category" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_category'] ,'</td>
							<td><input type="text" name="category" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_type" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_type'] ,'</td>
							<td>
								<select name="type">
						...
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_index" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_index'] ,'</td>
							<td><input type="checkbox" name="show_index" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_board" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_board'] ,'</td>
							<td><input type="checkbox" name="show_board" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_threadindex" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_threadindex'] ,'</td>
							<td><input type="checkbox" name="show_threadindex" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_thread" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_thread'] ,'</td>
							<td><input type="checkbox" name="show_thread" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_lastpost" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_lastpost'] ,'</td>
							<td><input type="checkbox" name="show_lastpost" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_topofpage" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_topofpage'] ,'</td>
							<td><input type="checkbox" name="show_topofpage" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_welcome" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_welcome'] ,'</td>
							<td><input type="checkbox" name="show_welcome" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_bottom" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_bottom'] ,'</td>
							<td><input type="checkbox" name="show_bottom" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_towerleft" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_towerleft'] ,'</td>
							<td><input type="checkbox" name="show_towerleft" /></td>
						</tr>
						<tr class="windowbg2">
							<td align="left"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_towerright" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_show_towerright'] ,'</td>
	...
	global $txt;
		...
		<div>
			<table class="tborder" align="center"  border="0" width="100%" cellspacing="1" cellpadding="4">
				<tr class="titlebg">
					<td colspan="2">', $txt['ad_management_credits'] ,'</td></tr>
				<tr class="windowbg2">
					<td width="70%">', $txt['ad_manage_show_credits'] ,'</td>
				</tr>
			</table>
...
function template_editAds()
{
	...
	echo '
		<div class="tborder">
		<form action="', $scripturl, '?action=admod;sa=edit;ad=', $advertsEdit['id'], '" method="post">
		<table border="0" width="100%" cellspacing="1" cellpadding="4" class="bordercolor">
			<tr class="titlebg">
				<td colspan="2">', $txt['ad_management_main'] ,' - ', $advertsEdit['name'] ,'</td>
			</tr>
			<tr class="windowbg2">
				<td width="35%" align="center"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_name" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_name'] ,'</td>
			...
			<tr class="windowbg2">
				<td colspan="2">
					<table border="0" width="80%" cellspacing="1" cellpadding="4">
						<tr class="windowbg2">
							<td align="left" width="55%"><a href="', $scripturl, '?action=admod;sa=help;help=ad_manage_boards" onclick="return reqWin(this.href);" class="help"><img src="', $settings['images_url'], '/helptopics.gif" alt="', $txt[119], '" align="top" /></a> ', $txt['ad_manage_admin_boards'] ,'</td>
...
function template_settingsAds()
{
	...
	echo '
		<div>
		    <form action="', $scripturl, '?action=admod;sa=settings;save" method="post">
			<table class="tborder" align="center"  border="0" width="80%" cellspacing="1" cellpadding="4">
				<tr class="titlebg">
					<td colspan="2">', $txt['ad_management_settings'] ,'</td></tr>
				<tr class="windowbg2">
...
function template_ads_copyright()
{
    ...
    $urlBoardurl = urlencode(base64_encode($boardurl));
    	...
    	echo '
	<form method="post" action="',$scripturl,'?action=admod;sa=copyright;save=1">
<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="titlebg">
			<td colspan="2">', $txt['ads_txt_copyrightremoval'], '</td>
		</tr>
	<tr class="windowbg2">
        ...
        <br />
        <a href="http://www.smfhacks.com/copyright_removal.php?mod=' . $modID .  '&board=' . $urlBoardurl . '" target="_blank">' . $txt['ads_txt_ordercopyright'] . '</a>
        </td>
	</tr>
    <tr class="windowbg2">
