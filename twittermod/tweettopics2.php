...
function TwitterThread()
{
	...
	$context[$context['admin_menu_name']]['tab_data'] = array(
			'title' =>  $txt['twitter_admin'],
			'description' => '',
			'tabs' => array(
				'settings' => array(
					'description' =>$txt['twitter_admin'],
				),
			),
		);
...
function TwitterThread2()
{
	...
	redirectexit('action=admin;area=twitter;sa=twitter');
}
...
function FacebookSettings()
{
	...
	$context[$context['admin_menu_name']]['tab_data'] = array(
			'title' =>  $txt['facebook_admin'],
			'description' => '',
			'tabs' => array(
				'fbsettings' => array(
					'description' => $txt['facebook_admin'],
				),
			),
		);	
...
function FacebookSettings2()
{
	...
	redirectexit('action=admin;area=twitter;sa=fbsettings');
}
