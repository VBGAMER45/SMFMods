...
function template_postmain()
{
	...
	<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="titlebg">
			<td>', $txt['postscheduler_postlist'], '</td>
		</tr>
		<tr class="windowbg">
			<td>
				...
				<table width="95%" cellspacing="0" align="center" cellpadding="4" class="tborder">
					...
					foreach ($context['schedule_posts'] as $key => $post)
					{
						echo '<tr class="' . $styleClass . '">
								...
								<td><a href="', $scripturl, '?action=postscheduler;sa=editpost;id=', $post['ID_POST'], '">', $txt['postscheduler_editpost'], '</a></td> 
							</tr>
						';
	...
	<tr class="windowbg">
					<td colspan="5" align="center"><a href="', $scripturl, '?action=postscheduler;sa=addpost">', $txt['postscheduler_addpost'], '</a></td>
				</tr>
				</table>
				</form>
				<br />
...
echo '
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		<tr class="titlebg">
			<td>', $txt['postscheduler_addpost'], '</td>
		</tr>
		<tr class="windowbg">
			<td>
			<form method="post" action="', $scripturl, '?action=postscheduler;sa=addpost2" name="frmfeed">
				<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4">
				<tr><td width="30%">', $txt['postscheduler_subject'], '</td><td><input type="text" name="subject" size="50" /></td></tr>
	...
	echo '
    	...
    	echo '
				...
				<tr><td width="30%">', $txt['postscheduler_topicid'], '</td><td><input type="text" name="topicid" size="10" value="0" /></td></tr>

				
				<tr><td width="30%">', $txt['postscheduler_forum'], '</td><td>
...
<tr><td width="30%">', $txt['postscheduler_msg_icon'], '</td><td>
...
echo '
   ...
   echo '</table>
				...
				<tr><td width="30%" align="right"><input type="checkbox" name="topiclocked" /></td><td>', $txt['postscheduler_topiclocked'], '</td></tr>
	...
	<table border="0" width="80%" cellspacing="0" align="center" cellpadding="4" class="tborder">
		...
		<tr class="windowbg">
			...
			<form method="post" action="', $scripturl, '?action=postscheduler;sa=editpost2" name="frmfeed">
				<table border="0" width="100%" cellspacing="0" align="center" cellpadding="4">
				<tr><td width="30%">', $txt['postscheduler_subject'], '</td><td><input type="text" name="subject" size="50" value="' . $context['schedulepost']['subject'] . '" /></td></tr>
...
echo '
	...
	echo '
    	...
    	echo '
				...
				<tr><td width="30%">', $txt['postscheduler_topicid'], '</td><td><input type="text" name="topicid" size="10" value="' . $context['schedulepost']['ID_TOPIC'] . '" /></td></tr>
...
echo '
   ...
   echo '</table>
				...
				<tr><td width="30%" align="right"><input type="checkbox" name="topiclocked" ', ($context['schedulepost']['locked'] ? ' checked="checked" ' : ''), ' /></td><td>', $txt['postscheduler_topiclocked'], '</td></tr>
